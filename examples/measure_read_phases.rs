...
use tsfile::compress::Lz4Compressor;
use tsfile::encoding::{Encoder, Decoder, GorillaEncoder, GorillaDecoder, Ts2DiffEncoder, create_decoder};
...
fn measure_lz4_compress(data: &[u8]) -> (Vec<u8>, Duration) {
    use tsfile::compress::Compressor;
...
fn measure_ts2diff_encode(num_values: usize) -> (Vec<u8>, Duration) {
    use tsfile::encoding::Ts2DiffEncoder;
